  <?php 
        include "+koneksi.php";
		$query = mysql_query("SELECT * FROM artikel INNER JOIN bidang_ilmu ON artikel.id_bidang=bidang_ilmu.id_bidang WHERE kategori='industri_kreatif'") or die(mysql_error());
		$nomor = 1;
