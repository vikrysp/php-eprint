  <?php 
        include "+koneksi.php";
		$query = mysql_query("SELECT * FROM artikel INNER JOIN bidang_ilmu ON artikel.id_bidang=bidang_ilmu.id_bidang WHERE kategori='teknobiologi'") or die(mysql_error());
		$nomor = 1;
